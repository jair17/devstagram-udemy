...
@section('title')
    {{__('Register on DevStagram')}}
@endsection
@section('content')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        <div class="md:w-6/12 p-5">
            <img src="{{asset('img/registrar.jpg')}}" alt="{{__('Register Image')}}"/>
        </div>
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-lg">
            <form method="POST" action="{{route('store')}}" autocomplete="off" novalidate>
                @csrf
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input type="email" id="email" name="email" placeholder="{{__('youremail@mail.com')}}"
