...
@section('content')
    <div class="flex justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            ...
            <div
                class="md:w-8/12 flex flex-col items-center md:justify-center md:py-10 md:items-start lg:w-6/12 px-5 py-10">
                <div class="flex items-center gap-2">
                    <p class="text-gray-700 text-2xl mb-5">{{$user->username}}</p>
                    @auth
                        @if($user->id === auth()->user()->id)
                            <a href="{{route('profile.edit')}}"
                               class="text-gray-900 hover:text-gray-600 cursor-pointer">
    ...
    <section class="container mx-auto mt-10">
        <h2 class="text-4xl text-center font-black my-10">{{__('Publications')}}</h2>
